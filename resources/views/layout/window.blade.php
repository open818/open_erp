            ...
            var SidebarTabHandler={
                Init:function(){
                    $(".tabItemContainer>li").click(function(){
                        ...
                        rowData = ADWindow.selectRow();console.log(rowData);
                        if(rowData){
                            alert(old_tab.table_id_name);
                        ...
                        curr_tab = ADWindow.currTab();alert('a');
                        if(curr_tab.loaded == '1'){alert('b');
                            if(parent == ''){
                                return;
                            }else{
                                var v = '';
                        ...
                        }else{alert('c');console.log(select_kv);
